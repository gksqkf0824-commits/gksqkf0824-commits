...
<p align="center">
  ...
  <img src="https://img.shields.io/github/followers/gksqkf0824-commits?label=Followers&style=flat&color=c850c0" alt="followers" />
</p>
---
...
<h4>🚗 Smart FMS</h4>
AI 기반 카셰어링 차량 내부 오염 감지 시스템<br/><br/>
- Segmentation으로 오염 면적 비율 산출<br/>
- 배차 차단 · 패널티 · 세차 API 자동 트리거<br/>
- 6인 팀 리딩 · Slack 알림 연동
</td>
<td width="50%" valign="top">
<h4>📱 DAMAGE</h4>
투두 + 일상 기록 + 핀터레스트형 이미지 공유 앱<br/><br/>
- React Native (Expo) + Spring Boot<br/>
- PostgreSQL · 디자인 시스템 적용<br/>
...
<td width="50%" valign="top">
<h4>🚌 On-gil (온길)</h4>
시각장애인용 온디바이스 버스 안내 시스템<br/><br/>
- YOLOv11n INT8 양자화 + ByteTracker<br/>
- ML Kit OCR · TTS/햅틱 피드백<br/>
